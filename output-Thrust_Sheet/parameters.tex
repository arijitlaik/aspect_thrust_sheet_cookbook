...
{\it Value:} cm=0.01, year=1, vel=-0.20
...
{\it Value:} if (x==0e3 && y>0.5e3, if(y<=1e3, vel*cm/year * (1.e3-y)/1.e3, 0), vel*cm/year); 0
...
{\it Value:} rigid_bottom, low_friction, plastic_cover
...
{\it Value:} if(y<0.5e3, 1, 0); if(y>=0.5e3 && y<=1.0e3, 1, 0); if(y>1.0e3,1, 0);
...
{\it Value:} 1.e20, 1.e20,  0.1e6, 20.e6
...
{\it Value:} bottom, top, left, right
...
{\it Value:} left x: function, right x: function, bottom: function
...
{\it Value:} basic statistics, composition statistics, temperature statistics, velocity statistics, visualization
